...
# RWフィルタ（INCLUDE_ONLY_RW=False なら全医師）
...
# --- 施設→医師リスト (主施設ベース, 1:N) ---
fac_to_docs: dict = {}
for _doc in analysis_docs_all:
    if _doc in doc_primary.index:
        _fac = doc_primary[_doc]
...
output_png = "intensive_extensive_margin_v2.png"
...
output_path = os.path.join(SCRIPT_DIR, "results", "physician_viewing_analysis_v2.json")
